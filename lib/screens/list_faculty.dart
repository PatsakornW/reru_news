...
import 'package:reru/screens/detail_faculty.dart';
import 'dart:convert';
...
class _FacultyState extends State<Faculty> {
  Future<List> getData() async {
    final uri = "${Api().domain}//getlist_app.php";
          ...
          itemBuilder: (context, i) {
            return Card(
              ...
              child: ListTile(
                ...
                title:
                    Text(list[i]['list_name'], style: TextStyle(fontSize: 20)),
                trailing: Icon(Icons.play_arrow_sharp,color: Colors.blue),
                onTap: () {
                  showDialog<String>(
                      context: context,
                      builder: (BuildContext context) => AlertDialog(
                            title: Text(list[i]['list_name']),
                            content: Container(
                                child: Column(
