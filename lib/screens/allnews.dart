...
class _AllnewsState extends State<Allnews> {
  ...
  void initState() {
    ...
    _getNewsHot.getNewsList();
    _getNewsNews.getNewsList();
  }
  ...
  getNewsHot _getNewsHot = getNewsHot();
  getNewsNews _getNewsNews = getNewsNews();
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                            ...
                            Future<void> add_view() async {
                              try {
                                ...
                                var res = await http.post(Uri.parse(uri),
                                    body: {
                                      "news_id": '${snapshot.data?[i].newsId}'
                                    });
              ...
              FutureBuilder<List<NewsModel>>(
                  future: _getNewsNews.getNewsList(),
                  builder: (context, snapshot) {
                    if (!snapshot.hasData) {
                      return Center(
                        child: Text(''),
