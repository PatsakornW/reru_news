...
if (isset($_GET["id"])) {
    ...
    join news on news.news_id = reply.news_id
    where reply.news_id = '$id'";
            ...
            <div class="teaser">
                ...
                <form action="edit.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <h> <?php echo $result['news_detail']; ?> </h><br>

                        <center><label for="news_img" class="col-form-label">ภาพข่าว </label><br>
                            <img class="rounded" width="50%" src="/reru/<?php echo $result['news_img']; ?>"></img>
                        </center> <br>


                        <!-- <h> <?php echo $result['username']; ?> <label > : </label><?php echo $result['text']; ?> </h><br> -->
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td width="100"><?php echo $rows['username']; ?></td>
                                        <td width="200px"><?php echo $rows['date']; ?></td>
